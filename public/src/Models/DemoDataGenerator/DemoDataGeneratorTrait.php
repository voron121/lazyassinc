...
trait DemoDataGeneratorTrait
{
    ...
    private array $issuesAuthors = [
        ...
        "Jennifer Davis (Graphic Designer)",
        "Tiffany Sparkle (Unicorn Trainer)",
        "Billy Bob Jenkins (Professional Napper)",
        "Sandy Beach (Beach Volleyball Coach)",
    ];
     ...
     * @return array
     */
    public function getIssueRandomAuthor(): string
    {
